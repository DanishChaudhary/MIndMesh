        ...
        <div className="bg-gradient-to-br from-white via-yellow-50 to-yellow-100 min-h-screen text-gray-800">
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <header className="mb-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div>
                        ...
                        <h1 className="text-2xl sm:text-3xl font-semibold mt-3">One-Word Substitution</h1>
                        <p className="text-gray-600 mt-1 max-w-2xl">
                            Choose a letter (A → Z) to practice one-word substitutions. Theme follows Idioms & Phrases (amber).
                        </p>
                    </div>

                    <div className="flex items-center gap-3">
                        <Link to="/quiz?type=top200ows" className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-white bg-gradient-to-r from-amber-700 to-amber-500 hover:from-amber-800 hover:to-amber-600 transition-all">
                            Top200 OWS
                        </Link>
                    </div>
                </header>
            ...
            <style jsx>{`
                .letter-card {
                    border-radius: 14px;
                    padding: 0.9rem;
                    background: linear-gradient(180deg, rgba(255,255,250,0.98), rgba(255,250,240,0.98));
