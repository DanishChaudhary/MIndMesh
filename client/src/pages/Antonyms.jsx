...
export default function Antonyms() {
    ...
    const handleLetterClick = (letter) => {
        navigate(`/vocab-antonyms/${letter}`)
    }

    return (
        <div className="bg-gradient-to-br from-white via-pink-50 to-pink-100 min-h-screen text-gray-800">
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <header className="mb-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div>
                        ...
                        <h1 className="text-2xl sm:text-3xl font-semibold mt-3">Antonyms</h1>
                        <p className="text-gray-600 mt-1 max-w-2xl">
                            Choose a letter (A → Z) to practice antonyms. Learn opposite meanings and contrasting words.
                        </p>
                    </div>

                    <div className="flex items-center gap-3">
                        <Link to="/quiz?type=top200antonyms" className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-white bg-gradient-to-r from-pink-700 to-pink-500 hover:from-pink-800 hover:to-pink-600 transition-all">
                            Top200 Antonyms
                        </Link>
                        <Link to="/synonyms" className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-white bg-gradient-to-r from-indigo-700 to-indigo-500 hover:from-indigo-800 hover:to-indigo-600 transition-all">
                            Synonyms
                        </Link>
                    </div>
                </header>
                    ...
                    <div className="flex gap-3 items-center">
                        <div className="flex-1 relative">
                            <input
                                ...
                                className="w-full rounded-xl bg-white shadow-sm border border-gray-100 pl-10 pr-4 py-3 focus:ring-0 focus:border-pink-300 focus:outline-none"
                            />
            ...
            <style jsx>{`
                .letter-card {
                    border-radius: 14px;
                    padding: 0.9rem;
                    background: linear-gradient(180deg, rgba(255,255,250,0.98), rgba(255,240,245,0.98));
                ...
                .letter-badge {
                    ...
                    font-weight: 700; 
                    font-size: 1.15rem;
                    background: linear-gradient(135deg, rgba(236,72,153,0.07), rgba(219,39,119,0.04));
                    color: #be185d;
                }
                .card-meta { 
                    display: flex; 
