...
export default function Synonyms() {
    ...
    const handleLetterClick = (letter) => {
        navigate(`/vocab-synonyms/${letter}`)
    }

    return (
        <div className="bg-gradient-to-br from-white via-indigo-50 to-indigo-100 min-h-screen text-gray-800">
            <div className="max-w-6xl mx-auto px-4 py-8">
                ...
                <header className="mb-6 flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                    <div>
                        ...
                        <h1 className="text-2xl sm:text-3xl font-semibold mt-3">Synonyms</h1>
                        <p className="text-gray-600 mt-1 max-w-2xl">
                            Choose a letter (A → Z) to practice synonyms. Expand your vocabulary with similar meanings.
                        </p>
                    </div>

                    <div className="flex items-center gap-3">
                        <Link to="/quiz?type=top200synonyms" className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-white bg-gradient-to-r from-indigo-700 to-indigo-500 hover:from-indigo-800 hover:to-indigo-600 transition-all">
                            Top200 Synonyms
                        </Link>
                        <Link to="/antonyms" className="inline-flex items-center gap-2 px-3 py-2 rounded-lg text-white bg-gradient-to-r from-pink-700 to-pink-500 hover:from-pink-800 hover:to-pink-600 transition-all">
                            Antonyms
                        </Link>
                    </div>
                </header>
                    ...
                    <div className="flex gap-3 items-center">
                        <div className="flex-1 relative">
                            <input
                                ...
                                className="w-full rounded-xl bg-white shadow-sm border border-gray-100 pl-10 pr-4 py-3 focus:ring-0 focus:border-indigo-300 focus:outline-none"
                            />
            ...
            <style jsx>{`
                .letter-card {
                    border-radius: 14px;
                    padding: 0.9rem;
                    background: linear-gradient(180deg, rgba(255,255,250,0.98), rgba(240,245,255,0.98));
