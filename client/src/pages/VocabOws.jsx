...
export default function VocabOws({ user }) {
    ...
    useEffect(() => {
        const fetchVocab = async () => {
            try {
                setLoading(true)
                const response = await axios.get(`/api/vocab/ows/${letter}`, {
    ...
    return (
        <div className="bg-gray-50 min-h-screen p-6 font-sans">
            <div className="max-w-4xl mx-auto">
                <Link to="/ows" className="text-sm text-blue-600 mb-5 hover:underline inline-flex items-center gap-2">
                ...
                <div className="flex items-center justify-between mt-4 mb-4">
                    <h1 className="text-2xl font-bold">Vocab of {letter}</h1>
                            ...
                            <div key={idx} className="p-6 bg-white rounded shadow hover:shadow-md transition-all">
                                <div className="flex items-start justify-between">
                                    ...
                                    <div className="pl-4 flex items-start hidden sm:flex">
                                        <Link 
                                            to={`/quiz?letter=${letter}&type=ows&page=${page}&pageSize=${pageSize}#q${item.word}`}
                ...
                <div className="mt-6 flex flex-col sm:flex-row gap-3">
                    <Link 
                        to={`/quiz?letter=${letter}&type=ows`}
