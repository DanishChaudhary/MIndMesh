        ...
        <section>
          ...
          <div className="mb-4">
            ...
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li><strong>6 Months Plan:</strong> ₹219 - Best value for comprehensive learning</li>
              <li><strong>12 Months Plan:</strong> ₹349 - Complete mastery with maximum savings</li>
            </ul>
          </div>
          <div className="mb-4">
